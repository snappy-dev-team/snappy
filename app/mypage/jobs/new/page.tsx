...
const labels: Record<string, string> = {
  ...
  job_salon_name_general: '店舗名',
  job_salon_area_general: '店舗エリア',
  job_nearest_station_general: '最寄り駅',
  job_salon_mood_general: '店舗の雰囲気',
  ...
  job_stylist_name_student: 'スタイリスト名（代表者名）',
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-5xl mx-auto px-4 md:px-8 py-10 space-y-8">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm text-muted-foreground">仕事募集追加</p>
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="outline" size="sm" className="border-destructive text-destructive" onClick={() => { clearSessionUser(); router.replace('/login') }}>
