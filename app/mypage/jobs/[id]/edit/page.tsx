...
function JobEditContent() {
  ...
  useEffect(() => {
    setGeneralTimeRange(parseTimeRangeValue(generalForm.job_time_range))
  }, [generalForm.job_time_range])

  useEffect(() => {
    setStudentTimeRange(parseTimeRangeValue(studentForm.job_time_range))
  }, [studentForm.job_time_range])
